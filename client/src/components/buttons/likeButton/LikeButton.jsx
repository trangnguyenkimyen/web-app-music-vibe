...
export default function LikeButton({ custom, type, itemId, playlist }) {
    ...
    const handleOnClickLike = async () => {
        if (user) {
            try {
                if (type === "song") {
                    const res = await axios.put(process.env.REACT_APP_API_URL + "/me/songs/" + itemId, { withCredentials: true });
                    ...
                    await axios.put(process.env.REACT_APP_API_URL + "/me/albums/" + itemId, { withCredentials: true });
                    if (liked) {
                    ...
                    await axios.put(process.env.REACT_APP_API_URL + "/me/playlists/" + itemId, { withCredentials: true });
                    if (liked) {
